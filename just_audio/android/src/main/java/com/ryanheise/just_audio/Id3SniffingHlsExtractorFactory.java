 ...
 * and replaces the Mp3 extractor with our Id3SniffingMp3Extractor() so timed
 * ID3 inside MP3 HLS fragments is emitted as application/id3 samples.
 */
public final class Id3SniffingHlsExtractorFactory implements HlsExtractorFactory {
  ...
  public HlsMediaChunkExtractor createExtractor(
    ...
    // Let the default factory decide first
    ...
    // If this is MP3 HLS, swap in the sniffing Mp3 extractor
